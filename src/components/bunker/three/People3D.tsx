...
const MARKER = new THREE.CylinderGeometry(0.3, 0.3, 0.02, 14);
    ...
    <group>
      {figures.map((f) => (
        <group
          ...
          raycast={() => null}
        >
          <mesh geometry={MARKER} material={materials.marker} position={[0, 0.06, 0]} raycast={() => null} />
          <mesh
            geometry={BODY}
